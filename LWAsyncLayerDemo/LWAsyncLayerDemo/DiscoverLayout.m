...
//                                                                        20.0f)];
    ...
    switch (imageCount) {
        case 0:self.imagesPosition = CGRectMake(60.0f, 60.0f + self.textTextLayout.boundsRect.size.height, 250.0f, 0.0f);
            break;
        case 1:self.imagesPosition = CGRectMake(60.0f, 60.0f + self.textTextLayout.boundsRect.size.height, 250.0f, 80.0f);
            break;
        case 2:self.imagesPosition = CGRectMake(60.0f, 60.0f + self.textTextLayout.boundsRect.size.height, 250.0f, 80.0f);
            break;
        case 3:self.imagesPosition = CGRectMake(60.0f, 60.0f + self.textTextLayout.boundsRect.size.height, 250.0f, 80.0f);
            break;
        case 4:self.imagesPosition = CGRectMake(60.0f, 60.0f + self.textTextLayout.boundsRect.size.height, 250.0f, 165.0f);
            break;
        case 5:self.imagesPosition = CGRectMake(60.0f, 60.0f + self.textTextLayout.boundsRect.size.height, 250.0f, 165.0f);
            break;
        case 6:self.imagesPosition = CGRectMake(60.0f, 60.0f + self.textTextLayout.boundsRect.size.height, 250.0f, 165.0f);
            break;
        case 7:self.imagesPosition = CGRectMake(60.0f, 60.0f + self.textTextLayout.boundsRect.size.height, 250.0f, 250.0f);
            break;
        case 8:self.imagesPosition = CGRectMake(60.0f, 60.0f + self.textTextLayout.boundsRect.size.height, 250.0f, 250.0f);
            break;
        case 9:self.imagesPosition = CGRectMake(60.0f, 60.0f + self.textTextLayout.boundsRect.size.height, 250.0f, 250.0f);
            break;
        default:self.imagesPosition = CGRectMake(60.0f, 60.0f + self.textTextLayout.boundsRect.size.height, 250.0f, 0.0f);
            break;
    }
